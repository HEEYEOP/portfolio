											...
											<ul>
												<c:forEach var="Asurvey" items="${Asurvey}">
													<c:if test="${Psurvey.surveyTypeNum == Asurvey.parentsQ}">
														<li>
															${Asurvey.surveyContents}
															<span class="partiNum">${Asurvey.totalNum}명(36.4%)</span>
															...
															<div class="bar">
																...
																<div class='resBar def_backColor <c:forEach var="isParticipation1" items="${isParticipation}">
																	<c:if test="${isParticipation1.participationSurveyTypeNum eq Asurvey.surveyTypeNum}">mychoice_backColor</c:if></c:forEach>
																' style="width: 36.4%;"></div>
