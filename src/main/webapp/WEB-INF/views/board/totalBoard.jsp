...
<head>
<meta charset="UTF-8">
<title>전체 게시물 페이지</title>
<link href="<%=request.getContextPath()%>/resources/css/totalBoard.css" rel="stylesheet">
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/totalBoard.js"></script>
</head>
				...
				<div class="bottomBorder">
					<div class="board">
						<div class="boardLeft">
							...
							<div class="titleBox">
								<c:if test="${board.boardType eq 'talkType'}">
									<h3>대화형</h3>
								</c:if>
								<c:if test="${board.boardType eq 'surveyType'}">
									<h3>설문형</h3>
								</c:if>
							...
							<ul class="stepBox">
								...
								<li class="step">
									<img src="https://www1.president.go.kr/img/ans_icon4.png">
									<p>댓글수</p>
									<p>[${board.likesCount}]</p>
								</li>
							</ul>
